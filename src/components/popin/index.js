            ...
            <div className="popin_areas">
              <div className="popin_left">
                <div className="popin_bloc">
                  <h2>1. { this.props.lang === 'fr' ? 'Modifier le texte' : 'Modify text'}</h2>
                  {/* <input type="text" /> */}
                ...
                <div className="popin_bloc">
                  <h2>2. { this.props.lang === 'fr' ? 'Modifier la légende' : 'Modify legend'}</h2>
                  {/* <input type="text" /> */}
                  <div className="popin_bloc_textfield">
                    <TextField
                      id="standard-legend"
              ...
              <div className="popin_right">
                <h2>3. { this.props.lang === 'fr' ? 'Changer la Photo' : 'Change picture'}</h2>
                ...
                <button className="popin_button--file commonButton" type="button">
                  <label htmlFor="file">
                    <span>{ this.props.lang === 'fr' ? 'CHOISIR UNE PHOTO' : 'CHOOSE A PICTURE'}</span>
                    <span>
