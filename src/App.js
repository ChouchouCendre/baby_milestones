  ...
  constructor() {
    ...
    this.state = {
      ...
      datas: JSON.parse(localStorage.getItem('chouchou_datas')) || [
        {
          label: langParam === 'en' ? 'MY FIRST PICTURE' : 'MA PREMIÈRE PHOTO', legend: '4m', img: 'img/baby1.jpg', crop: { x: 0, y: 0 }, zoom: 1,
        },
        {
          label: langParam === 'en' ? 'MY FIRST TOOTH' : 'J\'AI EU MA PREMIÈRE DENT À', legend: '6m', img: 'img/baby2.jpg', crop: { x: 0, y: 0 }, zoom: 1,
        },
        {
          label: langParam === 'en' ? 'I SAT BY MYSELFT AT' : 'JE ME SUIS ASSIS SEUL À', legend: '9m', img: 'img/baby3.jpg', crop: { x: 0, y: 0 }, zoom: 1,
        },
        {
          label: langParam === 'en' ? 'I HAVE CRAWLED AT' : 'J\'AI FAIT DU 4 PATTES À', legend: '11m', img: 'img/baby4.jpg', crop: { x: 0, y: 0 }, zoom: 1,
        },
        {
          label: langParam === 'en' ? 'I HAVE WALKED AT' : 'J\'AI MARCHÉ À', legend: '12m', img: 'img/baby5.jpg', crop: { x: 0, y: 0 }, zoom: 1,
        },
        {
          label: langParam === 'en' ? 'MY FIRST BIRTHDAY' : 'MON PREMIER ANNIVERSAIRE', legend: '12m', img: 'img/baby6.jpg', crop: { x: 0, y: 0 }, zoom: 1,
        },
        {
          label: langParam === 'en' ? 'MY FIRST SOLID MEAL' : 'J\'AI MANGÉ SEUL À', legend: '17m', img: 'img/baby7.jpg', crop: { x: 0, y: 0 }, zoom: 1,
        },
        {
          label: langParam === 'en' ? 'I HAVE SAID DADDY AT' : 'J\'AI DIT PAPA À', legend: '21m', img: 'img/baby8.jpg', crop: { x: 0, y: 0 }, zoom: 1,
        },
        {
          label: langParam === 'en' ? 'MY FIRST RIDE' : 'J\'AI DIT MAMAN À', legend: '24m', img: 'img/baby9.jpg', crop: { x: 0, y: 0 }, zoom: 1,
        },
      ],
      currentId: undefined,
      firstname: localStorage.getItem('chouchou_firstname') || 'Hugo',
      height: localStorage.getItem('chouchou_height') || langParam === 'en' ? '20 inches' : '50 cm',
      birthdate: localStorage.getItem('chouchou_birthdate') || langParam === 'en' ? '06/12/19' : '12/06/19',
      ...
      <React.Fragment>
        ...
        <div className="generate">
          <button type="button" onClick={this.clicPrint} className="chouchouButton commonButton">
            <span>{ this.state.lang === 'fr' ? 'IMPRIMER' : 'PRINT'}</span>
            <span>
        ...
        <div className="footer">
          <span>{ this.state.lang === 'fr' ? 'Crédits :' : 'Credits :'} <a href="http://www.lesaventuresduchouchou.com" target="_blank" rel="noopener noreferrer">Les Aventures du Chouchou Cendré</a></span>
          /
          <span>{ this.state.lang === 'fr' ? '🇬🇧  Also available in' : '🇫🇷  Aussi disponible en'} <a href="index.html">Français</a></span>
          /
          <span>{ this.state.lang === 'fr' ? '👥  Partager : ' : '👥  Share: '} <a href="TODO" target="_blank" rel="noopener noreferrer">Facebook</a> | <a href="TODO" target="_blank" rel="noopener noreferrer">Twitter</a> | <a href="TODO" target="_blank" rel="noopener noreferrer">Pinterest</a></span>
          /
